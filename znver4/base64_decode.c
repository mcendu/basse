...
size_t
base64_decoder_size_znver4 (void)
{
  return BASE64_MAX_DECODER_SIZE;
}

void
base64_decoder_init_znver4 (struct base64_decoder *restrict ctx)
{
...
bool
base64_decode_znver4 (struct base64_decoder *restrict ctx,
                      ...
                      char *restrict out, size_t *restrict outlen)
{
  if (ctx)
      ...
      while (input_remaining > 0)
        {
          ...
          size_t block_size = base64_denewline_znver4 (
          ...
          // decode
          switch (base64_decode_main_znver4 (ctx->buffer, &block_processed,
                                             out, &block_outputted))
            {
  ...
  else
    {
      ...
      int result = base64_decode_main_znver4 (in, &remaining, out, outlen);
