 ...
 */
#ifndef BASE64_DECODE_NEHALEM_H
#define BASE64_DECODE_NEHALEM_H
 ...
 */
int base64_decode_main_nehalem (const char *restrict in,
                                size_t *restrict inlen, char *restrict out,
 ...
 */
size_t base64_denewline_nehalem (char *restrict dst, const char *restrict src,
                                 size_t size);
